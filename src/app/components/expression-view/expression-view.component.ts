...
export class ExpressionViewComponent implements OnInit {
  ...
  likeMessage(): void {
    ...
    this.analyticsService.logEvent('expression_view_message_like', {
  ...
  replyMessage(): void {
    ...
    this.analyticsService.logEvent('expression_view_message_reply', {
      id: this.message?.id,
