...
export class ExpressionEditComponent implements OnInit {
  ...
  saveMessage(newMessage: Message): void {
    ...
    this.analyticsService.logEvent('expression_edit_save', {
  ...
  cancelEdit(): void {
    ...
    this.analyticsService.logEvent('expression_edit_cancel', {
      id: this.message?.id,
  ...
  deleteMessage(): void {
    ...
    this.analyticsService.logEvent('expression_edit_delete', {
      id: this.message?.id,
      title: this.message?.title, parent: this.parent,
      userId: this.user?.id,
    });
  ...
  restoreMessage(): void {
    ...
    this.analyticsService.logEvent('expression_edit_restore', {
